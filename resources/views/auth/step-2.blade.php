            ...
            <p style="padding:5px; color:#979FA5; margin-bottom:5px;">Tell us about yourself</p>
                ...
                <form method="POST" action="{{ route('success') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="number" type="text" class="form-control @error('name') is-invalid @enderror" name="number" required autocomplete="name" autofocus>
                    ...
                    <div class="mb-3" style="display:none;">
                        ...
                        <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" value="FWD23001" name="password" required autocomplete="new-password">
                        @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="mb-3" style="display:none;">
                        ...
                        <input id="password-confirm" type="password" class="form-control" name="password_confirmation" value="FWD23001" required autocomplete="new-password">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="referral_code" class="col-form-label" style="font-weight:bold;">Referral Code</label><span style="color:red;"> *</span>
                    ...
                    <div class="mb-3">
                        ...
                        <label class="col-form-label"> (PDF, DOC, DOCX Supported)</label>
                        <input id="resume" type="file" class="form-control @error('resume') is-invalid @enderror" name="resume" accept=".pdf,.doc,.docx" required>
                        @error('resume')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <h1 style="padding:5px; font-weight:bold;">II. Job Questionaire:</h1>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input id="very" type="radio" class="form-check-input" name="very" value="Very">
                            <label class="form-check-label" for="yes">Very interested</label>
                        </div>
                        <div class="form-check">
                        <input id="interested" type="radio" class="form-check-input" name="interested" value="Interested">
                            <label class="form-check-label" for="no">Kind of interested</label>
                        </div>
                        <div class="form-check">
                        <input id="not" type="radio" class="form-check-input" name="not" value="Not Interested">
                            <label class="form-check-label" for="no">Not interested</label>
                        </div>
                    </div>
